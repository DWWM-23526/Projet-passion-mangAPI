...
$app->addRoute(RequestMethod::GET, "/api/emailConfirm/{emailId}", "EmailConfirm\Controller\EmailConfirmController", "getEmailByEmail");
...
$app->addRoute(RequestMethod::DELETE, "/api/emailConfirm/{emailId}", "EmailConfirm\Controller\EmailConfirmController", "deleteEmailConfirm");
