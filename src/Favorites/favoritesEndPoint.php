...
$app->addRoute(RequestMethod::PUT, '/api/favorites/{favoriteId}', 'Favorites\Controller\FavoritesController', 'updateFavorite');

// DELETE remove a favorite
$app->addRoute(RequestMethod::DELETE, '/api/favorites/{favoriteId}', 'Favorites\Controller\FavoritesController', 'removeFavorite');
